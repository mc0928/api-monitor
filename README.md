...
- **单实例保护**：重复启动自动聚焦已有窗口，不会开出多份实例
- **托盘悬停摘要**：鼠标悬停托盘图标即可看到「N 正常 · M 异常 · 余额合计」
- **成功率趋势线**：全部站点展示近 24 小时成功率走势（new2api series / sub2api timeline / V2 buckets 三种数据源自动适配）
- **版本更新提示**：启动时检查 GitHub 最新发布，有新版时顶部横幅提醒
