...
const zh: Record<string, string> = {
  ...
  "dialog.password": "密码",
  "dialog.sub2apiHint":
    "站点开启人机验证（Turnstile）无法程序登录时，点「浏览器登录」在弹窗内完成登录，令牌自动捕获并长期保存",
  "dialog.webLogin": "浏览器登录",
  "dialog.webLoginOpened": "登录窗口已打开，请在窗口内完成登录（含人机验证）",
  "dialog.webLoginOk": "已捕获令牌，保存后即可正常刷新",
  "dialog.webLoginFailed": "未捕获到令牌，请在窗口完成登录后重试",
  "dialog.webLoginError": "打开登录窗口失败",
  "dialog.webLoginNeedUrl": "请先填写站点地址（以 http(s):// 开头）",
  "dialog.vpn": "走代理（vpn）",
  "dialog.delete": "删除渠道",
  "dialog.cancel": "取消",
  "dialog.save": "保存",
...
const en: Record<string, string> = {
  ...
  "filter.all": "All",
  "filter.noMatch": "No sites provide this model family",
  ...
  "dialog.sub2apiHint":
    "If the site has Turnstile verification and can't log in programmatically, click “Browser login” and finish signing in inside the popup — the token is captured and kept for future sessions",
  "dialog.webLogin": "Browser login",
  "dialog.webLoginOpened": "Login window opened — finish signing in there (captcha included)",
  "dialog.webLoginOk": "Token captured — save and the site will refresh normally",
  "dialog.webLoginFailed": "No token captured — sign in inside the window and retry",
  "dialog.webLoginError": "Failed to open login window",
  "dialog.webLoginNeedUrl": "Fill in the site URL first (must start with http(s)://)",
